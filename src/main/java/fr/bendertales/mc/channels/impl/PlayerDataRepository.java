...
import fr.bendertales.mc.channels.config.PlayerProperties;
import fr.bendertales.mc.channels.impl.vo.PlayerSettings;
...
public class PlayerDataRepository
	...
	public PlayerDataRepository() {
		super(ModConstants.MODID, PlayerProperties.class);
	}
