...
import fr.bendertales.mc.channels.impl.messages.FormattedMessage;
...
import fr.bendertales.mc.channels.impl.vo.PlayerChannelStatus;
...
public class ChatManager implements Messenger {
	...
	public void load() {
		...
		if (channel == null) {
			channel = channelsById.get(ModConstants.Ids.Channels.GLOBAL);
			if (channel == null) {
