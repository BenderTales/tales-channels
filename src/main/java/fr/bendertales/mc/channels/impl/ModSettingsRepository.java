package fr.bendertales.mc.channels.impl;
...
import fr.bendertales.mc.channels.config.ChannelProperties;
import fr.bendertales.mc.channels.config.ModProperties;
import fr.bendertales.mc.channels.config.PrivateMessageProperties;
import fr.bendertales.mc.channels.impl.messages.MessageFormatter;
import fr.bendertales.mc.channels.impl.vo.Channel;
import fr.bendertales.mc.channels.impl.vo.ModSettings;
import fr.bendertales.mc.channels.impl.vo.PrivateMessageFormatters;
...
public final class ModSettingsRepository extends ConfigRepository<ModSettings, ModProperties>{
	...
	public ModSettingsRepository() {
		super(ModProperties.class, ModPaths.createConfigFile(ModConstants.MODID));
	}
	...
	protected ModProperties getDefaultConfiguration() {
		...
		modConfiguration.setDefaultChannel(ModConstants.Ids.Channels.GLOBAL);
