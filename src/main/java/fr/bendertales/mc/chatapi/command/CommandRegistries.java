package fr.bendertales.mc.chatapi.command;

import java.util.List;
import java.util.stream.Stream;

import fr.bendertales.mc.chatapi.ChatConstants;
import fr.bendertales.mc.chatapi.command.nodes.root.*;
import fr.bendertales.mc.chatapi.impl.ChatManager;
import fr.bendertales.mc.chatapi.impl.channels.AdminChannel;
import fr.bendertales.mc.chatapi.impl.channels.HelpersChannel;
import fr.bendertales.mc.chatapi.impl.channels.ModerationChannel;
import fr.bendertales.mc.chatapi.impl.channels.StaffChannel;
