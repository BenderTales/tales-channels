package fr.bendertales.mc.chatapi;

import fr.bendertales.mc.chatapi.command.CommandRegistries;
import fr.bendertales.mc.chatapi.impl.ChatManager;
import fr.bendertales.mc.chatapi.impl.Registry;
import fr.bendertales.mc.chatapi.impl.channels.*;
import fr.bendertales.mc.chatapi.impl.formats.DateTimePlaceholderHandler;
import fr.bendertales.mc.chatapi.impl.formats.MessagePlaceholderHandler;
import fr.bendertales.mc.chatapi.impl.formats.RecipientPlaceholderHandler;
import fr.bendertales.mc.chatapi.impl.formats.SenderPlaceholderHandler;
